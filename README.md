...
***GNN is an emerging and powerful neural network approach. Its application are no longer limited to the original field, which has flourished in many other areas, such as Data Visualization, Image Processing, NLP, Recommendation System, Computer Vision, Bioinformatics, Chemical informatics, Drug Development and Discovery, Smart Transportation***
